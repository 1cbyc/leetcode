...
// the code should run without the examples, but since there are samplex, let me show the utility by example:
$solution = new Solution();
var_dump($solution->isMatch("aa", "a")); // this should output false
var_dump($solution->isMatch("aa", "*")); // this should output bool(true)
var_dump($solution->isMatch("cb", "?a")); //this should output false