...
export const validparentheses: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>when i first saw this problem, i immediately thought about using stack. the key insight is [to be filled based on the specific problem].</p>
      </section>
      <section className="space-y-3">
      ...
      <section className="space-y-3">
        ...
        <p>the valid parentheses problem is a great exercise in string, stack. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/valid-parentheses/solutions/1234569/valid-parentheses-solution-by-1cbyc).</p>
        <p>---</p>
