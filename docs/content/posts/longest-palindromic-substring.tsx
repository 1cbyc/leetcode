...
export const longestpalindromicsubstring: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>when i first saw this problem, i immediately thought about using expand around center. the key insight is [to be filled based on the specific problem].</p>
      </section>
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>**optimized approach** - Expand Around Center</li>
          <li>**alternative approach** - [alternative approach if applicable]</li>
        </ul>
      </section>
      <section className="space-y-3">
        <h3 className="text-lg font-semibold">Solution Strategy</h3>
        <p>i decided to use a <strong>Expand Around Center</strong> with the following strategy:</p>
        <ul className="list-disc space-y-2 pl-5">
      ...
      <section className="space-y-3">
        ...
        <p>the longest palindromic substring problem is a great exercise in string, dynamic programming. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/longest-palindromic-substring/solutions/1234569/longest-palindromic-substring-solution-by-1cbyc).</p>
        <p>---</p>
