...
export const trappingrainwater: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>the trapping rain water problem is a great exercise in array, two pointers. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/trapping-rain-water/solutions/1234569/trapping-rain-water-solution-by-1cbyc).</p>
        <p>---</p>
