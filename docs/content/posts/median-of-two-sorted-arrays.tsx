  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>when i first saw this problem, i immediately thought about using binary search on smaller array. the key insight is [to be filled based on the specific problem].</p>
      </section>
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>**optimized approach** - Binary Search on Smaller Array</li>
          <li>**alternative approach** - [alternative approach if applicable]</li>
        </ul>
      </section>
      <section className="space-y-3">
        <h3 className="text-lg font-semibold">Solution Strategy</h3>
        <p>i decided to use a <strong>Binary Search on Smaller Array</strong> with the following strategy:</p>
        <ul className="list-disc space-y-2 pl-5">
      ...
      <section className="space-y-3">
        ...
        <p>the median of two sorted arrays problem is a great exercise in array, binary search. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/median-of-two-sorted-arrays/solutions/1234569/median-of-two-sorted-arrays-solution-by-1cbyc).</p>
        <p>---</p>
