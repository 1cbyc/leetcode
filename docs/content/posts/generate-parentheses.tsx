...
export const generateparentheses: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>the generate parentheses problem is a great exercise in string, backtracking. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/generate-parentheses/solutions/1234569/generate-parentheses-solution-by-1cbyc).</p>
        <p>---</p>
