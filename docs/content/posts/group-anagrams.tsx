...
export const groupanagrams: LeetCodePost = {
  slug: "group-anagrams",
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>when i first saw this problem, i immediately thought about using hash map. the key insight is [to be filled based on the specific problem].</p>
      </section>
      <section className="space-y-3">
      ...
      <section className="space-y-3">
        ...
        <p>the group anagrams problem is a great exercise in string, hash table. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/group-anagrams/solutions/1234569/group-anagrams-solution-by-1cbyc).</p>
        <p>---</p>
