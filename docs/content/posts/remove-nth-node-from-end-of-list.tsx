...
export const removenthnodefromendoflist: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>when i first saw this problem, i immediately thought about using two pointers. the key insight is [to be filled based on the specific problem].</p>
      </section>
      <section className="space-y-3">
      ...
      <section className="space-y-3">
        ...
        <p>the remove nth node from end of list problem is a great exercise in linked list, two pointers. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/remove-nth-node-from-end-of-list/solutions/1234569/remove-nth-node-from-end-of-list-solution-by-1cbyc).</p>
        <p>---</p>
