...
export const findfirstandlastpositionofelementinsortedarray: LeetCodePost = {
  ...
  body: () => (
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>the find first and last position of element in sorted array problem is a great exercise in array, binary search. the key insight is [key takeaway].</p>
        <p>you can find my complete solution on [leetcode](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/solutions/1234569/find-first-and-last-position-of-element-in-sorted-array-solution-by-1cbyc).</p>
        <p>---</p>
